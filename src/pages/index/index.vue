<template>
  <view class="container timer" :class="{ 'timer--running': isRunning }">
    ...
    <view class="timer_footer">
      <view
        ...
        data-type="work"
        class="timer_ctrl"
        :class="{ hide: isRunning && timerType == 'rest' }"
      >
        {{ isRunning ? "退出" : "工作" }}
      </view>
      ...
      <view
        ...
        data-type="rest"
        class="timer_ctrl_2"
        :class="{ hide: isRunning && timerType == 'work' }"
      >
        {{ isRunning ? "退出" : "休息 " }}
      </view>
    </view>
  ...
  methods: {
      ...
      this.isRunning = !this.isRunning
			...
			this.log = {
				...
				action: actionName[this.isRuning ? 'stop' : 'start'],
				type: this.timerType
			}
